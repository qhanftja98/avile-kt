...
if (name == '🕗8시-13시') and (time_input == datetime.date(2023,1,4)) :
...
elif name == '🕐13시-18시'and (time_input == datetime.date(2023,1,4)):
...
elif name == '🕕18시-23시'and (time_input == datetime.date(2023,1,4)) :
